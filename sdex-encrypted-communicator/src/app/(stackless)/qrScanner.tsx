  ...
  return (
    <View /* style={styles.container} */ className="flex-1 items-center justify-between bg-black">
      ...
      <View style={styles.cameraInnerContainer}>
        <BarCodeScanner onBarCodeScanned={handleBarCodeScanned} style={styles.cameraScanner} />
      </View>
      {scanned ? (
        <>
          <Button className="mb-30 w-40 bg-gray-700" mode="contained" onPress={handleScanAgain}>
            Skanuj ponownie
          </Button>
          <IconButton
            className="mb-20"
