// UI
export const GENERIC_LOCAL_STORAGE_UI_ERROR_MSG = "Błąd komunikacji z bazą danych.";
...
export const GENERIC_LOCAL_STORAGE_SQL_QUERY_FAILURE_MSG = "Query executed with error: ";
export const GENERIC_LOCAL_STORAGE_SQL_QUERY_SUCCESS_MSG = "Query executed successfully.";
export const GENERIC_LOCAL_STORAGE_SECURESTORE_ERROR_MSG = "SecureStore db connection error: ";
